    ...
    static void getQuotes(final Context context) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                //if stock does not exists show message and remove it from prefs}
                float price;
                float change;
                float percentChange;
                try{
                    ...
                    mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(context, context.getString(R.string.error_stock_no_data, symbol), Toast.LENGTH_SHORT).show();
                        }
                    });
